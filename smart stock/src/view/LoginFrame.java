...
import main.DBConnection; // Import your DBConnection class
    ...
    private void initializeDatabase() {
        try {
            ...
            int choice = JOptionPane.showConfirmDialog(this,
                    "Continue without database connection? (Some features will be disabled)",
                    "Database Error",
            ...
            if (user != null) {
                ...
                if (databaseConnection != null && !databaseConnection.isClosed()) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this,
                                "Database connection unavailable. Starting in offline mode.",
                                "Warning",
                                JOptionPane.WARNING_MESSAGE);
                        // You might want to create a limited version of HomeFrame here
                        new HomeFrame(user, null).setVisible(true); // Pass null for offline mode
                    }
                }
